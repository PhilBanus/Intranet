  ...
  foreach ($holidays->getHolidayDates() as $thdate) {
    ...
    <tr>
        ...
        <td> 
            ...
            @if($Row->LineManager === session('MY_ID'))
            
                  <span href="" class="material-tooltip-main LNapprove_claim" data-id="{{$Row->GUID}}" style="z-index: 100" data-toggle="tooltip"
  title="Approve"><i class="fas fa-thumbs-up text-success mr-2 waves-effect"></i></span>
            
            <span href="" class="material-tooltip-main LNreject_claim" data-id="{{$Row->GUID}}" data-toggle="tooltip"
               title="Reject"><i class="fas fa-thumbs-down text-danger mr-2 waves-effect"></i></span> 
            
            @elseif($Row->PM === session('MY_ID') && $Row->Line_Approved == true)
            
            
                <span href="" class="material-tooltip-main PMapprove_claim" data-id="{{$Row->GUID}}" style="z-index: 100" data-toggle="tooltip"
  title="Approve"><i class="fas fa-thumbs-up text-success mr-2 waves-effect"></i></span>
            
            <span href="" class="material-tooltip-main PMreject_claim" data-id="{{$Row->GUID}}" data-toggle="tooltip"
               title="Reject"><i class="fas fa-thumbs-down text-danger mr-2 waves-effect"></i></span> 
       ...
       <span class=" material-tooltip-main" data-toggle="tooltip" title="Rejected - {{base64_decode($Row->Reject_Reason)}}">
        ...
        <td>
       <?php if(is_base64_encoded($Row->DESC)){ echo base64_decode($Row->DESC);}else{ echo $Row->DESC; }  ?>
        </td>
        <td>
