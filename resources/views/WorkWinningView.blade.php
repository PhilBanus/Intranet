...
<!-- Editable table -->
<div class="d-flex p-2 text-warning"><div id="date" class="text-warning mr-1 fa-2x"></div><spa class="fa-2x"> - </spa><div id="time" class="text-warning ml-1 fa-2x"></div> <div class="ml-auto bg-white rounded p-2"><img src="{{ asset('public/images/HochtiefLogo.png') }}" alt="" height="50px"></div></div>
