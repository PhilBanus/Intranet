...
<div class="col-md-9 bg-light">
	...
	<div class="card bg-transparent border-0 mb-1 p-0 z-depth-0 h-100">
				<div class="card-header bg-transparent border-0">Comments</div>

	<div class="card-body">
		
		<div class="d-flex justify-content-left">
		<div class="btn btn-sm reply">Reply</div>
		</div>
		
		<div class="white p-2 border-left border-secondary mb-2 " id="respond">
	<textarea id="Comment" class="card-text form-control rounded-0 border-0" placeholder="Enter response here"></textarea>
			<div class="small text-muted text-right"><div class="btn btn-sm border-0 btn-light z-depth-0" id="AddComment"><i class="fas fa-paper-plane"></i></div> </div>
...
<script>
	...
	$('#AddComment').on('click',function(){
		...
		$.post('HelpUpdate',{comment:comment,user:user,id:id,type:"Comment"}).done(function(result){
			$('#CommentsList').prepend(result.element)
		})
