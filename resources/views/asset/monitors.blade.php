...
<div class="accordion md-accordion accordion-1" id="accordionEx1" role="tablist" aria-multiselectable="true">
  ...
  <div class="card">
    ...
    <div id="ProjectCollapse1" class="collapse" role="tabpanel" aria-labelledby="headingTwo1"
      ...
      <div class="card-body bg-dark white-text">
...
Add or Edit Monitors
		  ...
		  <ul class="list-group">
			  ...
			  foreach($Monitors as $Monitor){
				  ...
				  echo "<li class='list-group-item list-group-item-action' data-id='$Monitor->Serial_Number' data-make='$Monitor->Make' data-model='$Monitor->Model'> <span>$Monitor->Make: $Monitor->Serial_Number</span> </li>";
